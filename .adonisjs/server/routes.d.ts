...
export type ScannedRoutes = {
  ALL: {
    ...
    'sales.cash_sessions.index': { paramsTuple?: []; params?: {} }
    'sales.cash_sessions.show': { paramsTuple: [ParamValue]; params: {'id': ParamValue} }
    ...
    'sales.recoveries.overview': { paramsTuple?: []; params?: {} }
